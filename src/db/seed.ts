...
// ---------------------------------------------------------------------------
// Feature presets — cycled per property (index % count)
// ---------------------------------------------------------------------------
const featurePresets = [
  { nearSubway: true,  needsRenovation: false, parkingAvailable: false, hasElevator: true,  estimatedCapacityPeople: 350, floorLevel: 22, conditionRating: 5, recommendedUse: "office",      amenities: ["lobby", "security", "conference-rooms", "gym"],            confidenceScore: "0.95" },
  { nearSubway: true,  needsRenovation: true,  parkingAvailable: false, hasElevator: true,  estimatedCapacityPeople: 120, floorLevel: 8,  conditionRating: 2, recommendedUse: "retail",      amenities: ["lobby", "loading-dock"],                                    confidenceScore: "0.82" },
  { nearSubway: false, needsRenovation: false, parkingAvailable: true,  hasElevator: false, estimatedCapacityPeople: 50,  floorLevel: 1,  conditionRating: 4, recommendedUse: "restaurant",  amenities: ["courtyard", "ev-charging"],                                 confidenceScore: "0.91" },
  { nearSubway: false, needsRenovation: false, parkingAvailable: true,  hasElevator: false, estimatedCapacityPeople: 200, floorLevel: 1,  conditionRating: 3, recommendedUse: "warehouse",   amenities: ["loading-dock", "security"],                                 confidenceScore: "0.88" },
  { nearSubway: true,  needsRenovation: false, parkingAvailable: true,  hasElevator: true,  estimatedCapacityPeople: 500, floorLevel: 15, conditionRating: 5, recommendedUse: "office",      amenities: ["lobby", "security", "gym", "rooftop", "conference-rooms"],  confidenceScore: "0.97" },
  { nearSubway: false, needsRenovation: true,  parkingAvailable: true,  hasElevator: false, estimatedCapacityPeople: 30,  floorLevel: 2,  conditionRating: 2, recommendedUse: "retail",      amenities: ["bike-storage"],                                             confidenceScore: "0.74" },
  { nearSubway: true,  needsRenovation: false, parkingAvailable: false, hasElevator: true,  estimatedCapacityPeople: 80,  floorLevel: 5,  conditionRating: 4, recommendedUse: "medical",     amenities: ["lobby", "security", "ev-charging"],                         confidenceScore: "0.89" },
  { nearSubway: false, needsRenovation: false, parkingAvailable: true,  hasElevator: true,  estimatedCapacityPeople: 250, floorLevel: 10, conditionRating: 4, recommendedUse: "mixed-use",   amenities: ["lobby", "rooftop", "co-working", "bike-storage"],           confidenceScore: "0.93" },
  { nearSubway: true,  needsRenovation: true,  parkingAvailable: false, hasElevator: false, estimatedCapacityPeople: 40,  floorLevel: 3,  conditionRating: 1, recommendedUse: "studio",      amenities: ["courtyard"],                                                confidenceScore: "0.68" },
  { nearSubway: false, needsRenovation: false, parkingAvailable: true,  hasElevator: false, estimatedCapacityPeople: 150, floorLevel: 1,  conditionRating: 3, recommendedUse: "retail",      amenities: ["loading-dock", "ev-charging", "security"],                  confidenceScore: "0.85" },
  { nearSubway: true,  needsRenovation: false, parkingAvailable: true,  hasElevator: true,  estimatedCapacityPeople: 400, floorLevel: 18, conditionRating: 5, recommendedUse: "tech",        amenities: ["lobby", "gym", "rooftop", "co-working", "bike-storage"],    confidenceScore: "0.96" },
  { nearSubway: false, needsRenovation: true,  parkingAvailable: false, hasElevator: false, estimatedCapacityPeople: 20,  floorLevel: 1,  conditionRating: 2, recommendedUse: "restaurant",  amenities: ["courtyard"],                                                confidenceScore: "0.71" },
  { nearSubway: false, needsRenovation: false, parkingAvailable: true,  hasElevator: true,  estimatedCapacityPeople: 300, floorLevel: 12, conditionRating: 4, recommendedUse: "office",      amenities: ["lobby", "security", "conference-rooms", "ev-charging"],    confidenceScore: "0.92" },
  { nearSubway: true,  needsRenovation: false, parkingAvailable: false, hasElevator: true,  estimatedCapacityPeople: 60,  floorLevel: 6,  conditionRating: 3, recommendedUse: "residential", amenities: ["lobby", "gym", "bike-storage"],                             confidenceScore: "0.84" },
  { nearSubway: false, needsRenovation: false, parkingAvailable: true,  hasElevator: false, estimatedCapacityPeople: 100, floorLevel: 1,  conditionRating: 4, recommendedUse: "retail",      amenities: ["loading-dock", "security", "ev-charging"],                  confidenceScore: "0.90" },
  { nearSubway: true,  needsRenovation: false, parkingAvailable: true,  hasElevator: true,  estimatedCapacityPeople: 180, floorLevel: 9,  conditionRating: 5, recommendedUse: "medical",     amenities: ["lobby", "security", "conference-rooms"],                    confidenceScore: "0.94" },
  { nearSubway: false, needsRenovation: true,  parkingAvailable: true,  hasElevator: false, estimatedCapacityPeople: 75,  floorLevel: 2,  conditionRating: 1, recommendedUse: "warehouse",   amenities: ["loading-dock"],                                             confidenceScore: "0.66" },
  { nearSubway: true,  needsRenovation: false, parkingAvailable: false, hasElevator: true,  estimatedCapacityPeople: 220, floorLevel: 14, conditionRating: 4, recommendedUse: "tech",        amenities: ["lobby", "co-working", "rooftop", "gym"],                    confidenceScore: "0.91" },
  { nearSubway: false, needsRenovation: false, parkingAvailable: true,  hasElevator: false, estimatedCapacityPeople: 45,  floorLevel: 1,  conditionRating: 3, recommendedUse: "studio",      amenities: ["courtyard", "bike-storage"],                                confidenceScore: "0.79" },
  { nearSubway: true,  needsRenovation: false, parkingAvailable: true,  hasElevator: true,  estimatedCapacityPeople: 450, floorLevel: 25, conditionRating: 5, recommendedUse: "mixed-use",   amenities: ["lobby", "security", "gym", "rooftop", "ev-charging"],       confidenceScore: "0.98" },
];

// ---------------------------------------------------------------------------
// Broker notes — randomly sampled (1–4) per property
// ---------------------------------------------------------------------------
const brokerNotes = [
...
// ---------------------------------------------------------------------------
// Properties — 275 entries across 20 US cities
// ---------------------------------------------------------------------------
const properties = [
  // === New York (15) ===
...
// ---------------------------------------------------------------------------
// Deterministic note assignment: cycle through brokerNotes 1–4 per property
// (mirrors the PHP rand logic with a deterministic fallback for reproducibility)
// ---------------------------------------------------------------------------
function pickNotes(index: number): string[] {
  const count = (index % 4) + 1; // 1, 2, 3, or 4
  const notes: string[] = [];
  for (let j = 0; j < count; j++) {
    notes.push(brokerNotes[(index * 7 + j * 13) % brokerNotes.length]);
  }
  return notes;
}
...
async function main() {
  ...
  for (let i = 0; i < properties.length; i++) {
    ...
    if (inserted.length === 0) {
      console.log(`  [${i + 1}/${properties.length}] Skipped (conflict): ${entry.name}`);
      continue;
    }
    ...
    // Insert broker notes
    const selectedNotes = pickNotes(i);
    for (const noteText of selectedNotes) {
      await db
        .insert(schema.notes)
        .values({ propertyId, note: noteText })
        .onConflictDoNothing();
    }

    // Insert feature preset (cycled)
    const preset = featurePresets[i % featurePresets.length];
    await db
      .insert(schema.propertyFeatures)
      .values({
        propertyId,
        nearSubway: preset.nearSubway,
        needsRenovation: preset.needsRenovation,
        parkingAvailable: preset.parkingAvailable,
        hasElevator: preset.hasElevator,
        estimatedCapacityPeople: preset.estimatedCapacityPeople,
        floorLevel: preset.floorLevel,
        conditionRating: preset.conditionRating,
        recommendedUse: preset.recommendedUse,
        amenities: preset.amenities,
        confidenceScore: preset.confidenceScore,
        sourceNotesCount: selectedNotes.length,
        rawAiResponse: { model: "gpt-4o", prompt_version: "v2" },
        extractedAt: new Date(),
      })
      .onConflictDoNothing();

    console.log(`  [${i + 1}/${properties.length}] Inserted: ${entry.name}`);
  }

  console.log(`Done! Seeded ${properties.length} properties.`);
  process.exit(0);
}
